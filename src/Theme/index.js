...
const theme = (darkMode, color) => ({
  ...
  // uniswapPink: darkMode ? '#FFB047' : 'black',
  ...
  advancedBG: darkMode ? '#151719' : '#FFFDFA',
  onlyLight: darkMode ? '#101010' : '#f1f2f4',
  divider: darkMode ? 'rgba(43, 43, 43, 0.435)' : 'rgba(43, 43, 43, 0.035)',

  //primary colors
  primary1: darkMode ? '#2172E5' : '#FFB047',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#FFB047',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#FFB047',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #FFB047 30 0%, #fff 0%)`
})
